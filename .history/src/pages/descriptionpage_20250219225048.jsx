        ...
        <div className=" h-screen">
            ...
            <div className="flex flex justify-around p-4">
                <div className="w-[1000px] ">
                    <div className="w-[1000px] h-[480px] rounded-xl border-gray border-2 bg-white ">
                ...
                <div className="rounded-xl border-gray border-2 bg-white w-[250px]">
                    <div className='text-center font-[600] mt-2'>Related</div>
                  </div>
            </div>
        </div>
    );
