    ...
    return(
        <div className=" h-screen">
            <div className="flex justify-around p-4">
                ...
                <div className="mt-[30px] mb-2 mr-[150px] rounded-xl border-gray border-2 bg-white w-[250px]">
                    <div className='text-center font-[600] mt-3'>
                        Related
                    </div>
                    <div className="w-[213px] h-[115px] rounded-[10px] border ml-2 border-[1px] mt-2 pb-[16px] pl-[8px] gap-[8px]">
