        ...
        <div className=" h-screen font-inter   flex justify-center p-3 ">
            <div className="bg-gray-200 w-1/2 rounded-sm flex flex-col justify-center items-center">
              <div className="bg-[#fff] w-2/3 h-fit flex flex-col justify-center p-6 rounded-tr-lg drop-shadow-md">
                ...
                <input className="mb-3 h-[35px] border border-gray-300 rounded-tr-lg shadow-sm focus:outline-none font-sans ease-in-out" type="text" placeholder="Software Engineer" />
                ...
                <input className="mb-3 mb-3 h-[35px] border border-gray-300 rounded-tr-lg shadow-sm focus:outline-none" type="text" placeholder="9600" />
              </div>
