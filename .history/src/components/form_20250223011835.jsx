      ...
      <div className="bg-gray-200 w-1/2 rounded-sm flex flex-col justify-center items-center">
        ...
        <form onSubmit={handleSubmit} className="bg-[#fff] w-2/3 h-fit flex flex-col justify-center p-6 rounded-tr-lg drop-shadow-md">
          ...
          <input
            ...
            onBlur={handleBlur}
            className="mb-3 h-[35px] border border-gray-300 rounded-tr-lg shadow-sm focus:outline-none font-sans font-light"
            type="text"
          ...
          <input
            ...
            onChange={handleChange}
            onBlur={handleBlur}
            className="mb-3 h-[35px] border border-gray-300 rounded-tr-lg shadow-sm focus:outline-none font-light"
            type="text"
